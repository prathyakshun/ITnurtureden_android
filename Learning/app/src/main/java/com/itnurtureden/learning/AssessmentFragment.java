...
public class AssessmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_assessment2, container, false);
        ...
        cookieManager.setCookie("http://www.itnurtureden.com/quiz",cookieString);
        ...
        pbar.setScaleY(5f);
        WebView wvAssess = (WebView) mainview.findViewById(R.id.wvCourse);
        wvAssess.setWebChromeClient(new WebChromeClient() {
        ...
        wvAssess.setWebViewClient(new MyWebViewClient());
        String cookies = CookieManager.getInstance().getCookie("http://www.itnurtureden.com/courses");
        Log.e("cookies",cookies);
        wvAssess.getSettings().setDomStorageEnabled(true);
        WebSettings settings = wvAssess.getSettings();
        settings.setJavaScriptEnabled(true);
        //    Log.e("courseurl",courseUrl);
        wvAssess.loadUrl("http://itnurtureden.com/courses/assess");
        Log.e("pls","pls");
        return mainview;
    }
